...
(() => {
  ...
  injectStyle(`
    ...
    .gtt-node{padding:6px 6px 6px 8px;border-radius:8px;margin:2px 0;cursor:pointer;position:relative;display:flex;flex-wrap:wrap;align-items:center;gap:4px 6px}
    ...
    .gtt-node .pv{flex:1 1 220px;min-width:0;display:block;opacity:.9;margin-left:0;margin-top:2px;white-space:normal;overflow:visible;text-overflow:clip;word-break:break-word}
